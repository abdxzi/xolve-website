...
const testimonials = [
  {
    ...
    name: "Ethan S",
    content:
      "The dApp developed by the team was beyond my expectations. It has a sleek design, seamless functionality, and has helped attract more users to our blockchain platform. Highly recommend them!",
    categories: [1, 2],
  },
  {
    clientImg: Female,
    name: "Sophia L",
    content:
      "The trading bot they built for me has significantly improved my profit margins. It’s fast, reliable, and incredibly efficient at analyzing market trends. I’m thrilled with the results!",
    categories: [1, 3],
  },
  {
    clientImg: Male,
    name: "Jackson B",
    content:
      "The smart contract they delivered was flawless. It was secure, well-documented, and integrated perfectly with our ecosystem. I’ll definitely work with them again.",
    categories: [1, 4],
  },
  {
    clientImg: Female,
    name: "Liam W",
    content:
      "I was in need of a modern website for my startup, and this team delivered exactly what I envisioned. The user interface is clean, responsive, and functional. Amazing work!",
    categories: [1, 5],
  },
  {
    clientImg: Male,
    name: "Oliver K",
    content:
      "Their expertise in dApp development is unmatched. The platform they created has taken our project to new heights with its robust performance and user-friendly interface.",
    categories: [1, 2, 4],
  },
  {
    clientImg: Female,
    name: "Emily R",
    content:
      "As a trader, I’ve tried multiple bots, but the one developed by this team is on another level. It’s incredibly intuitive and has made trading a lot less stressful for me.",
    categories: [1, 3],
  },
  {
    clientImg: Male,
    name: "Noah H",
    content:
      "Working with this team on a smart contract project was a fantastic experience. They ensured top-notch security and followed the latest blockchain standards. I couldn’t be happier!",
    categories: [1, 4],
  },
  {
    clientImg: Female,
    name: "Ava T",
    content:
      "Their perceptual trading market app revolutionized the way I trade. It’s fast, accurate, and keeps me ahead of the competition. Great work by the team!",
    categories: [1, 3],
  },
  {
    clientImg: Male,
    name: "Lucas D",
    content:
      "From concept to deployment, the dApp they created was nothing short of exceptional. The communication was clear, and they truly understood the project’s goals. Highly recommended!",
    categories: [1, 2, 5],
  },
];
;
